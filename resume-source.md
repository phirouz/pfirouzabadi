...
seyed-parsa.firouzabadi@gmail.com
linkedin.com/in/seyed-parsa-firouzabadi

## Summary
Electrical Engineering student with experience building AI-enabled systems, supporting technical teams through data analysis, documentation, and structured coordination.

## Education
York University, BEng in Electrical Engineering — Sep 2023 – Present
Coursework: Electronic Circuits and Devices, Digital Logic Design, Signals and Systems, Introduction to Machine Learning, Introduction to Power Systems, Power Systems Analysis Laboratory, Introduction to Embedded Systems, Linear Control Systems

## Experience

### AI Developer (Co-op), Aecon Group
16-month co-op placement building agents and automation tools using Microsoft Copilot Studio, Azure AI Foundry, and Python.

### Finance at Large — York University Engineering Society (LES)
Sep 2024 – Present
...
### Research Assistant — Robot Tutor Project, York University
May 2025 – Aug 2025
...
### AI-Powered Job Search Application — 2026
...
### AI Copilot Adoption & Governance Dashboard — 2026
...
### Distribution Network Design & Power Flow Analysis (MATLAB/Python) — Apr 2026
...
### Power System Protection & Equipment Sizing for Industrial Facility (MATLAB) — Apr 2026
...
### Digital Signal Processing Project — Dec 2025
...
### FPGA-Based Password Lock System — Apr 2025
...
### Winner — York Engineering Competition (YEC), Senior Design — Oct 2025
...
### Winner — York Engineering Competition (YEC), Programming — Oct 2024
...
**Technical:** Python, MATLAB, SQL, Git, FastAPI, JavaScript, C, Java, C#, Verilog, Embedded Systems, Embedded Linux, Arduino, AutoCAD, Altium Designer, LTspice, PSpice

**AI & Automation:** Generative AI, Retrieval-Augmented Generation (RAG), LLM API Integration, OpenAI API, Microsoft Copilot Studio, Azure AI Foundry

**Microsoft & Enterprise Tools:** Microsoft 365 (Teams, SharePoint, OneDrive, Outlook), Power BI, Advanced Excel

**Data & Reporting:** Data Analysis, Data Visualization, Process Analysis

**Professional:** Technical Documentation, Stakeholder Communication, Cross-functional Collaboration

## Languages
Persian (Fluent), English (Fluent), Arabic (Basic)
